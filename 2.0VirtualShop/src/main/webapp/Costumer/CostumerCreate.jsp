...
function sendData() {
	...
	if (valido &&= email) {
			...
			var url = '/TiendaVirtualNewYork/CreateCostumer';
...
<font face="Comic Sans MS,arial">
	<body>
		<center>
			<br></br> <br></br>
			<h1>Sección de agregar clientes</h1>
			<br></br> <br></br> <br></br>
		</center>
		...
		<center>
			<label for="txtIDcard">ID Card: </label> <input type="number"
				class="fondo" id="txtIDcard" name="IDcard"> <br> <br>
			<label for="txtName">Nombre: </label> <input type="text"
				class="fondo1" id="txtName" name="Name"> <br> <br>
			<label for="txtAddress">Dirección: </label> <input type="text"
				class="fondo2" id="txtAddress" name="Address"> <br> <br>
			<label for="txtPhone">Teléfono: </label> <input type="text"
				class="fondo3" id="txtPhone" name="Phone"> <br> <br>
			<label for="txtEmail">Email: </label> <input type="email"
				class="fondo4" id="txtEmail" name="Email"> <br></br>
		</center>
		<br></br>
		<center>
		...
		<center>
			<button
				onclick="location.href='/TiendaVirtualNewYork/Costumer/Menu.jsp'"
				class="btnEffect2">Menú Cliente</button>
		</center>
...
<!--  <button
			...
			<br></br> <br></br> <br></br> <input type='button'
				onclick="location.href='http://localhost:8080/TiendaVirtualApp/Costumer/Menu.jsp'"
				value='Menu Cliente'
