...
<script>
 ...
 <body> 
    ...
    <br></br>
		...
		<label for="txtIDcard">Cédula: </label> <input type="number" class="fondo"
		...
		<label for="txtUser">Usuario: </label> <input type="text" class="fondo3" id="txtUser"
			name="User"> <br> <br> <label for="txtPassword">Contraseña:
...
<br></br>
<center>
<a href="#" class="button2" onclick="location.href='/TiendaVirtualNewYork/User/Menu.jsp'">Menú Usuario</a>
</center>
    <!--  
