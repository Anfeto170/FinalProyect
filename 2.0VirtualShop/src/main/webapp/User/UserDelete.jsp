...
<script>
	...
	function sendData() {
		...
		if (valido) {
			...
			var url = '/TiendaVirtualNewYork/DeleteUser';
...
<center>
    <center>
    <h1>Sección de eliminar usuarios</h1>
    <br></br>
    <br></br>
    <br></br>
    <br></br>
		 <!--  El método post, hace que se ejectu get pero no muestra nada en URL -->
		<td><label for="txtIDcard">Cédula del usuario que se va a eliminar:</label></td>
    ...
    <br></br>
	    ...
	    <br></br>
	    <center>
		<button onclick="location.href='/TiendaVirtualNewYork/User/Menu.jsp'" class="btnEffect2">Menú Usuario</button>
		</center>
...
<br></br>
<br></br>
	<h1><FONT face="Comic Sans MS,arial" COLOR="black">Sección de eliminar usuarios</FONT></h1>
<br></br>
<br></br>
<br></br>
</center>	
<center>
	...
	<input type="number" id="txtIDcard" name="IDcard">
<br></br>	
<br></br>
	...
	<br></br>
	<br></br>
<input type='button' onclick="location.href='http://localhost:8080/TiendaVirtualApp/User/Menu.jsp'" value='Menú Usuario' style='width:250px; height:50px; background-color: #FF5555; border: none; color: white; padding: 16px 32px; text-decoration: none; margin: 4px 2px; cursor: pointer'' >
	<br>
	<br>
	<div id="dvTabla"></div>
</center>
